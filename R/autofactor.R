...
#' 
#' @param dfdata The dataframe containing the column(s) requiring factor conversion.
#' @param dflabels The dataframe containing the data dictionary/labels.
#' @param vars A vector containing the column names that should be factor converted. Argument should be supplied as character.
#' @param order Should the resulting factor levels be ordered?  Argument should be supplied as TRUE/FALSE.
#' @param suffix The suffix to the resulting factor column name to distinguish it from the original. Argument should be supplied as character. Not supplying will overwrite the original column.
#' @param nolabel The name of the level which unmatched levels are assigned to.  Argument should be supplied as character.
#' 
#' @keywords autofactor
#' 
#' @export
