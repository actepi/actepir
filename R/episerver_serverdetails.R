...
#' 
#' @param feature The feature/detail to be returned. Can be one of: "driver", "server", "port", "default_db" or "default_schema". Argument should be supplied as character.
#' 
#' @keywords episerver
#' 
#' @export
